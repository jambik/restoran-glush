...
<div class="main-container">
    ...
    <section id="about-us">
        <div class="container">
            <div class="row">
                <div class="col-sm-4 text-center">
                    <div class="circle-icon">
                        <img src="{{ asset('img/icon-menu.png') }}" style="margin-top: 30px;">
                    </div>
                ...
                <div class="col-sm-4 text-center">
                    <div class="circle-icon">
                        <img src="{{ asset('img/icon-event.png') }}" style="margin-top: 40px;">
                    </div>
                ...
                <div class="col-sm-4 text-center">
                    <div class="circle-icon">
                        <img src="{{ asset('img/icon-nature-and-pond.png') }}" style="margin-top: 30px;">
                    </div>
            ...
            <div class="row">
                <div class="col-sm-5">
                    <img src="{{ asset('img/about-us.jpg') }}" class="img-responsive img-thumbnail">
                </div>
                <div class="col-sm-7">
